...
public class AmqpClient {
    ...
    private static String accessKey = "LTAI5tPdUA9kdHbUsgmskrSa";
    private static String accessSecret = "qe0xvCl94GOrUNHxim6l8nilCzb4yr";
    private static String consumerGroupId = "VShGyBTnAAk67ki1xPaY000100";//消费组ID
    ...
    private static String clientId = "idea";

    //${YourHost}为接入域名，请参见AMQP客户端接入说明文档。
    private static String host = "1070249641458789.iot-amqp.cn-shanghai.aliyuncs.com";
    //id+域名
    // 指定单个进程启动的连接数
