...
import com.hz.utils.monitor.DeviceInfoResponse;
 ...
 * 获取设备信息
 */
public class GetDeviceInfo extends AbstractAPI {

    private String deviceSerial;
    private HttpPostMethod httpPostMethod;
    public GetDeviceInfo(String url, String accessToken, String deviceSerial) {
        this.url = url;
